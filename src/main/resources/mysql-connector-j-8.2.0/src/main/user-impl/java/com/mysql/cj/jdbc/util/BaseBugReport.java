 ...
 *
 * <p>
 * Finally, create a 'appl_main.main' method that creates a new instance of your testcase, and calls the 'run' method:
 *
 * <pre>
 *
 * public static void appl_main.main(String[] args) throws Exception {
 *     new MyBugReport().run();
 * }
 * </pre>
 *
