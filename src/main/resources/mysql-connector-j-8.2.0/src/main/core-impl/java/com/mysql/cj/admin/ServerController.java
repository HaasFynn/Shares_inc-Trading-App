...
public class ServerController {
    ...
    /**
     * Starts the server, returning a java.appl_main.lang.Process instance that represents
     * the mysql server.
     *
     * @return Process a java.appl_main.lang.Process instance representing the mysql
     *         server process.
     * @throws IOException
